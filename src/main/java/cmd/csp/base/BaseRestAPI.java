...
public class BaseRestAPI  {
	protected Vertx vertx;
	  ...
	  public static final String API_RETRIEVE = API_VERSION + "/process/:service/:config/:message";
	  public static final String API_POST = API_VERSION + "/process/:service/:config";
	// TODO add admin and maybe other specialized apis
	public BaseRestAPI(Vertx vertx) {
		this.vertx=vertx;
	}
		  ...
		  protected void enableLocalSession(Router router) {
		    ...
		    router.route().handler(SessionHandler.create(
		      LocalSessionStore.create(vertx, "csp.user.session")));
		  }
		  ...
		  protected void enableClusteredSession(Router router) {
		    router.route().handler(CookieHandler.create());
		    router.route().handler(SessionHandler.create(
		      ClusteredSessionStore.create(vertx, "csp.user.session")));
		  }
