...
public class ConfigClassify extends BaseConfig implements IConfig {
	...
	public boolean init(String name, Vertx vertx) {
		...
		jCon.put("percent.header", 14);
		jCon.put("percent.footer", 10);
		jCon.put("percent.left", 7);
		jCon.put("percent.right", 7);
		jCon.put("page.words", true);
