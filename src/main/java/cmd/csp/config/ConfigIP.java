...
public class ConfigIP extends BaseConfig implements IConfig {
	...
	public boolean init(String name, Vertx vertx) {
		...
		jCon.put("pattern.ip", "(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\.(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\.(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\.(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])");
