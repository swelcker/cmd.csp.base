...
public class ConfigOCR extends BaseConfig implements IConfig {
	...
	public boolean init(String name, Vertx vertx) {
		...
		jCon.put("mode", 0);
		jCon.put("preprocessing.enable", true);
		jCon.put("langdetect.enable", true);
		jCon.put("langdetect.pages", 1);
		jCon.put("language", "deu+eng");
		jCon.put("image.format", "tiff");
		jCon.put("imagesize.min.w", 300);
		jCon.put("imagesize.min.h", 300);
