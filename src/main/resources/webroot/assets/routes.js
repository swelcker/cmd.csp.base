  ...
  .state('app.workitems', {
    ...
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
          // you can lazy load controllers
          return $ocLazyLoad.load({
            files: ['assets/views/workitems/workitems.js']
          });
        }]
      }
  })
  ...
  .state('app.templates', {
    ...
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
          // you can lazy load controllers
          return $ocLazyLoad.load({
            files: ['assets/views/templates/templates.js']
          });
        }]
      }
  })
  ...
  .state('app.workflow', {
    ...
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
          // you can lazy load controllers
          return $ocLazyLoad.load({
            files: ['assets/views/workflow/workflow.js']
          });
        }]
      }
  })
  ...
  .state('app.configuration', {
    ...
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
          // you can lazy load controllers
          return $ocLazyLoad.load({
            files: ['assets/views/configuration/configuration.js']
          });
        }]
      }
  })
